...
class SO2 extends StatefulWidget {
  const SO2({super.key});

  @override
  State<SO2> createState() => _SO2State();
}

class _SO2State extends State<SO2> {
  @override
                    ...
                    SingleChildScrollView(
                      child: Column(
                        children: [
                          ...
                          const SizedBox(height: 30),
                          _buildInputField("SO₂ (µg/m³)", so2Controller,
                              calcularSO2, _getFormulaSO2),
                              ...
                              onPressed: () {
                                if (_areAllFieldsFilled()) {
                                  double valor = double.parse(
                                      so2Controller.text.replaceAll(',', '.'));
                                  double resultado = calcularSO2(valor);
  ...
  bool _areAllFieldsFilled() {
    return so2Controller.text.isNotEmpty;
  }

  double calcularSO2(double cl) {
    if (cl >= 0 && cl <= 20) {
      return (40 / 20) * cl;
    } else if (cl > 20 && cl <= 40) {
      return ((80 - 41) / (40 - 20)) * (cl - 20) + 41;
    } else if (cl > 40 && cl <= 365) {
      return ((120 - 81) / (365 - 40)) * (cl - 40) + 81;
    } else if (cl > 365 && cl <= 800) {
      return ((200 - 121) / (800 - 365)) * (cl - 365) + 121;
    } else if (cl > 800) {
      return ((cl - 800) * (200 / 100)) + 200;
    } else {
      return double.nan;
    }
  }
  ...
  String _getFormulaSO2(double cl) {
    if (cl >= 0 && cl <= 20) {
      return "IQAr = (40 / 20) * concentração";
    } else if (cl > 20 && cl <= 40) {
      return "IQAr = ((80 - 41) / (40 - 20)) * (concentração - 20) + 41";
    } else if (cl > 40 && cl <= 365) {
      return "IQAr = ((120 - 81) / (365 - 40)) * (concentração - 40) + 81";
    } else if (cl > 365 && cl <= 800) {
      return "IQAr = ((200 - 121) / (800 - 365)) * (concentração - 365) + 121";
    } else if (cl > 800) {
      return "IQAr = ((concentração - 800) * (200 / 100)) + 200";
    } else {
