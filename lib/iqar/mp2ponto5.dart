...
TextEditingController mp25Controller = TextEditingController();

class MP25 extends StatefulWidget {
  const MP25({super.key});

  @override
  State<MP25> createState() => _MP25State();
}

class _MP25State extends State<MP25> {
  @override
                    ...
                    SingleChildScrollView(
                      child: Column(
                        children: [
                          ...
                          const SizedBox(height: 30),
                          _buildInputField("MP2,5 (µg/m³)", mp25Controller,
                              calcularMP25, _getFormulaMP25),
                              ...
                              onPressed: () {
                                if (_areAllFieldsFilled()) {
                                  double valor = double.parse(
                                      mp25Controller.text.replaceAll(',', '.'));
                                  double resultado = calcularMP25(valor);
  ...
  bool _areAllFieldsFilled() {
    return mp25Controller.text.isNotEmpty;
  }

  double calcularMP25(double cl) {
    if (cl >= 0 && cl <= 25) {
      return (40 / 25) * cl;
    } else if (cl > 25 && cl <= 50) {
      return ((80 - 41) / (50 - 25)) * (cl - 25) + 41;
    } else if (cl > 50 && cl <= 75) {
      return ((120 - 81) / (75 - 50)) * (cl - 50) + 81;
    } else if (cl > 75 && cl <= 125) {
      return ((200 - 121) / (125 - 75)) * (cl - 75) + 121;
    } else if (cl > 125) {
      return ((cl - 125) * (200 / 100)) + 200;
    } else {
      return double.nan;
    }
  }
  ...
  String _getFormulaMP25(double cl) {
    if (cl >= 0 && cl <= 25) {
      return "IQAr = (40 / 25) * concentração";
    } else if (cl > 25 && cl <= 50) {
      return "IQAr = ((80 - 41) / (50 - 25)) * (concentração - 25) + 41";
    } else if (cl > 50 && cl <= 75) {
      return "IQAr = ((120 - 81) / (75 - 50)) * (concentração - 50) + 81";
    } else if (cl > 75 && cl <= 125) {
      return "IQAr = ((200 - 121) / (125 - 75)) * (concentração - 75) + 121";
    } else if (cl > 125) {
      return "IQAr = ((concentração - 125) * (200 / 100)) + 200";
    } else {
