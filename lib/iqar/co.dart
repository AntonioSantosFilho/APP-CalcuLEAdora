...
class _COState extends State<CO> {
                    ...
                    SingleChildScrollView(
                      child: Column(
                        children: [
                          ...
                          const SizedBox(height: 30),
                          _buildInputField("CO (ppm)", coController, calcularCO,
                              _getFormulaCO),
                              ...
                              onPressed: () {
                                if (_areAllFieldsFilled()) {
                                  double valor = double.parse(
                                      coController.text.replaceAll(',', '.'));
                                  double resultado = calcularCO(valor);
  ...
  bool _areAllFieldsFilled() {
    return coController.text.isNotEmpty;
  }

  double calcularCO(double cl) {
    if (cl >= 0 && cl <= 9) {
      return (40 / 9) * cl;
    } else if (cl > 9 && cl <= 11) {
      return ((80 - 41) / (11 - 9)) * (cl - 9) + 41;
    } else if (cl > 11 && cl <= 13) {
      return ((120 - 81) / (13 - 11)) * (cl - 11) + 81;
    } else if (cl > 13 && cl <= 15) {
      return ((200 - 121) / (15 - 13)) * (cl - 13) + 121;
    } else if (cl > 15) {
      return ((cl - 15) * (200 / 100)) + 200;
    } else {
      return double.nan;
    }
  }
  ...
  String _getFormulaCO(double cl) {
    if (cl >= 0 && cl <= 9) {
      return "IQAr = (40 / 9) * concentração";
    } else if (cl > 9 && cl <= 11) {
      return "IQAr = ((80 - 41) / (11 - 9)) * (concentração - 9) + 41";
    } else if (cl > 11 && cl <= 13) {
      return "IQAr = ((120 - 81) / (13 - 11)) * (concentração - 11) + 81";
    } else if (cl > 13 && cl <= 15) {
      return "IQAr = ((200 - 121) / (15 - 13)) * (concentração - 13) + 121";
    } else if (cl > 15) {
      return "IQAr = ((concentração - 15) * (200 / 100)) + 200";
    } else {
