...
class IetReservatorios extends StatefulWidget {
  const IetReservatorios({super.key});

  @override
  State<IetReservatorios> createState() => _IetReservatoriosState();
}

class _IetReservatoriosState extends State<IetReservatorios> {
  @override
  ...
  Widget _buildInputField(String labelText, TextEditingController controller,
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: const Color.fromARGB(119, 175, 175, 175),
        borderRadius: BorderRadius.circular(10),
      ),
      child: Row(
        children: [
          ...
          Expanded(
            ...
            child: TextField(
              ...
              decoration: InputDecoration(
                filled: true,
                fillColor: const Color.fromARGB(119, 187, 216, 254),
